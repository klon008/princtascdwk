...
| Терминология | **[x]** Коллекция / Серия (с рубашкой) / Бустер / Тираж / Альбом — см. [SPEC.md §2](./SPEC.md#2-глоссарий) |
| Редкости | **[x]** 7 уровней: common → … → mythic → secretRare — [SPEC.md §9](./SPEC.md#9-редкость-и-шансы) |
...
|-----------|--------|------------|
| Сайт-галерея | React + Vite, 28 карт + рубашка серии | [`src/app/App.tsx`](src/app/App.tsx) |
...
CREATE TABLE booster_rarity_weights (
  booster_id  TEXT NOT NULL,
  rarity      TEXT NOT NULL,   -- common | uncommon | rare | epic | legendary | mythic | secretRare
...
- [x] **Рубашка серии** — характеристика серии (не коллекционная карта, не в `user_cards`); на сайте — декоративный слот каталога
...
```json
{
  ...
  "u": "GoodGameNick",
  "series": [
    { "id": "fantast", "name": "Фантастический коллекционер", "owned": 12, "total": 28 }
  ],
  "collection": { "owned": 12, "total": 28 },
  "cards": [
    {
      "id": "ariel",
      "name": "Ариэль",
...
- [x] ~~Силуэты «из 28» с пустыми слотами~~
...
- [ ] Счётчик на сайте: «12 карт» vs «12/28»
