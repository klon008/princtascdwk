import type { Catch } from "@/lib/fishingApi";

/** Фикстуры для ?maket=true — дизайн без бэкенда. */
export const MOCK_WEEKLY: Catch[] = [
  { fish: "Жерех", player: "klon_008", weight: 3.99 },
  { fish: "Карась", player: "klon_008", weight: 0.92 },
  ...
  { fish: "Сазан", player: "klon_008", weight: 8.45 },
